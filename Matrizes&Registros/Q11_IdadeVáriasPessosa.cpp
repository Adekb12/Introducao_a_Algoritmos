...
int main (){
	...
	for (int i=0;i<n;i++){
		...
		if (pessoa[i].ano>a or (pessoa[i].ano==a and pessoa[i].mes>m) or (pessoa[i].ano==a and pessoa[i].mes==m and pessoa[i].dia>d))
			cout<<-1<<endl;
		else if (a-pessoa[i].ano<2 or (a-pessoa[i].ano==2 and m<pessoa[i].mes) or (a-pessoa[i].ano==2 and m==pessoa[i].mes and d>pessoa[i].dia)){
			if (pessoa[i].ano==a or (a-pessoa[i].ano==1 and pessoa[i].mes>m) or (a-pessoa[i].ano==1 and pessoa[i].mes==m and pessoa[i].dia>d))
				cout<<"0 ano"<<endl;
			else
				cout<<"1 ano"<<endl;	
		}else{
